...
//where everything is stored for a member
...
member* create_member() {
	...
	//everything for making a member
...
void save_file(member* head) {
	...
	member* tmp = head;
	while (tmp != NULL) {
		//options that also get written to file
		fprintf(f, "\n==========================================\n");
...
int main() {
	...
	while (option != 0) {
		...
		//checking which option user picked
